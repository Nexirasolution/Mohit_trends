...
export default function WhatsAppButton({
  ...
  return (
    <a
      ...
      className="fixed bottom-20 right-4 sm:bottom-6 sm:right-6 z-[60] flex items-center gap-2.5 bg-black text-white transition-all duration-300 px-4 py-3.5"
      style={{ paddingRight: hovered ? '1.25rem' : '0.9rem' }}
    >
      {/* Icon kept in WhatsApp's own color — recognizability matters more
          than strict palette purity for a functional contact affordance */}
      <svg viewBox="0 0 32 32" className="w-[18px] h-[18px] shrink-0" fill="#25D366">
      ...
      <span
        className="overflow-hidden whitespace-nowrap text-[10px] tracking-[0.15em] uppercase transition-all duration-300"
        style={{
