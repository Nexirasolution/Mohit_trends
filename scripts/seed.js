...
async function main() {
  ...
  // 1. Admin account
  const email = (process.env.ADMIN_EMAIL || 'admin@mohittrends.com').toLowerCase();
  ...
  if (!existingSettings) {
    await Settings.create({
      key: 'global',
      storeName: 'Mohit Trends',
      whatsapp: '919398281672',
      instagram: 'Mohit trends',
      address: 'Tirupathi, Chennai, Tamil Nadu',
      shippingFee: 49,
      freeShippingAbove: 999,
      seoTitle: 'Mohit trends - Women Kurtis',
      seoDescription: 'Shop trendy women kurtis from Mohit trends, Thirupathi.'
    });
